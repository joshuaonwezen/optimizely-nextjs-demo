...
interface BranchFinderWidgetProps {
  placeholder?: string | null;
  buttonLabel?: string | null;
  defaultRadius?: number | null;
}

export default function BranchFinderWidget({ placeholder, buttonLabel, defaultRadius }: BranchFinderWidgetProps) {
  const initialRadius = RADIUS_OPTIONS.includes(defaultRadius ?? 0) ? (defaultRadius as number) : 500;
